...
### v26.1.6.06 (2026-01-06)
- **버그 수정**: 프로필 이미지 업로드 시 간헐적으로 발생하던 500 에러 해결
  - API 라우트 런타임 명시 (`nodejs`) 및 파일 객체 유효성 검사 로직 개선

### v26.1.6.05 (2026-01-06)
- **UX 개선**: 전문가 목록(`/investigators`) 자동 순서 변경(셔플) 기능 비활성화 (고정된 목록 유지)
