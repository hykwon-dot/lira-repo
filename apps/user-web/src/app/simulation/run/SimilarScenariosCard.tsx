...
export const SimilarScenariosCard = ({ scenarios }: { scenarios: ScenarioCardProps[] }) => {
  ...
  return (
    <motion.div layout className="bg-slate-800/50 rounded-lg border border-slate-700 backdrop-blur-sm">
      <button
