...
const FALLBACK_DB_URL = "mysql://admin:LiraStrongPass2025!@lira-db-optimized.ctkse40gyfit.ap-northeast-2.rds.amazonaws.com:3306/lira?ssl={\"rejectUnauthorized\":false}&connect_timeout=10&pool_timeout=10";
