...
export async function GET(request: NextRequest) {
  ...
  switch (provider) {
    ...
    case 'google':
      ...
      authUrl = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${googleClientId}&redirect_uri=${encodeURIComponent(redirectUri)}&response_type=code&scope=email profile`;
      break;
